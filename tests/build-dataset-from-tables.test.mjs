...
test("buildMailings: joins subscription/subscriber/order, computes suggestedShipDate/overdue/dueNext14Days live, extracts orderId from the stable id", () => {
...
test("buildMailings: missing order (skipped by dual-write) leaves orderDate empty instead of throwing", () => {
  const subscriptionsById = new Map([
    ["SUBSCRIPTION-1", { id: "SUBSCRIPTION-1", subscriberId: "SUB-1", character: "Oliver", termType: "One-time", status: "Active", startedAt: null, totalLettersExpected: 1, recipientName: "Bob", addressLine1: null, addressLine2: null, city: null, state: null, zip: null }],
  ]);
  ...
  const mailingRows = [
    { id: "ORD-9::Oliver::1", subscriptionId: "SUBSCRIPTION-1", appMailingId: "MAIL-X", lastSourceRow: "10", letterNumber: 1, scheduledDate: "2026-08-12", status: "To Prepare", recipientName: "Bob", addressLine1: null, addressLine2: null, city: null, state: null, zip: null, stagingLocationId: null },
  ];
  const [result] = buildMailings(mailingRows, subscriptionsById, subscribersById, ordersById, TODAY);
...
test("buildRecipients: groups subscriptions by (subscriberId, name, address), aggregates characters/totalMailings/nextShipDate from the already-built mailings", () => {
  const subscriptionRows = [
    { id: "S1", subscriberId: "SUB-1", character: "Marley", termType: "Month-to-month", status: "Active", startedAt: null, totalLettersExpected: 2, recipientName: "Alice Smith", addressLine1: "1 Main St", addressLine2: null, city: null, state: null, zip: null },
    { id: "S2", subscriberId: "SUB-1", character: "Oliver", termType: "6-month", status: "Active", startedAt: null, totalLettersExpected: 12, recipientName: "Alice Smith", addressLine1: "1 Main St", addressLine2: null, city: null, state: null, zip: null },
  ];
...
test("buildRecipients: nextShipDate is empty when no mailing is Active+open", () => {
  const subscriptionRows = [
    { id: "S1", subscriberId: "SUB-1", character: "Marley", termType: "Month-to-month", status: "Active", startedAt: null, totalLettersExpected: 2, recipientName: "Alice", addressLine1: "1 Main St", addressLine2: null, city: null, state: null, zip: null },
  ];
...
test("buildSubscribers: status is Active if ANY subscription is Active, firstOrderDate is the earliest orderedAt, issueCount counts that subscriber's exceptions", () => {
  ...
  const subscriptionRows = [
    { id: "S1", subscriberId: "SUB-2", character: "Marley", termType: "Month-to-month", status: "Active", startedAt: null, totalLettersExpected: 2, recipientName: "B1", addressLine1: null, addressLine2: null, city: null, state: null, zip: null },
    { id: "S2", subscriberId: "SUB-2", character: "Oliver", termType: "One-time", status: "Archived", startedAt: null, totalLettersExpected: 1, recipientName: "B2", addressLine1: null, addressLine2: null, city: null, state: null, zip: null },
  ];
  const orderRows = [
...
test("buildOrders: resolves subscriberId/plan via the subscription join, computes billingMonth from createdOn", () => {
  const subscriptionsById = new Map([["S1", { id: "S1", subscriberId: "SUB-1", character: "Marley", termType: "Month-to-month", status: "Active", startedAt: null, totalLettersExpected: 2, recipientName: "A", addressLine1: null, addressLine2: null, city: null, state: null, zip: null }]]);
...
test("buildSubscriptions: generatedMailings counts actual mailings for that subscription (not totalLettersExpected), endDate is the documented gap", () => {
  const subscriptionRows = [
    { id: "S1", subscriberId: "SUB-1", character: "Marley", termType: "Month-to-month", status: "Active", startedAt: new Date("2026-06-01T00:00:00.000Z"), totalLettersExpected: 2, recipientName: "A", addressLine1: "1 Main St", addressLine2: null, city: null, state: null, zip: null },
  ];
  const mailings = [
...
test("buildDatasetFromRows: composes all seven entities and returns automationRules as an empty array", () => {
  ...
  const subscriptionRows = [{ id: "S1", subscriberId: "SUB-1", character: "Marley", termType: "Month-to-month", status: "Active", startedAt: new Date("2026-06-01T00:00:00.000Z"), totalLettersExpected: 2, recipientName: "Alice", addressLine1: "1 Main St", addressLine2: null, city: null, state: null, zip: null }];
  const orderRows = [{ id: "O1", subscriptionId: "S1", externalOrderNumber: "1001", amount: null, orderedAt: new Date("2026-06-01T00:00:00.000Z") }];
  const mailingRows = [
    { id: "O1::Marley::1", subscriptionId: "S1", appMailingId: "MAIL-1", lastSourceRow: "5", letterNumber: 1, scheduledDate: "2026-08-01", status: "To Prepare", recipientName: "Alice", addressLine1: "1 Main St", addressLine2: null, city: null, state: null, zip: null, stagingLocationId: null },
  ];
  const exceptionRows = [];
